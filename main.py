...
def predict():
    if request.method == 'POST':
        ...
        my_precautions = []
        for i in precautions_to_take[0]:
        ...
        return render_template('index.html', predicted_dis=predicted_disease, disease_desc=disease_description, precautions=my_precautions, meds=my_medications)
